...
public class App {
    public static void main(String[] args) {
        ...
        printCars((Iterator) sedan.theCars());
        printCars((Iterator) hatchback.theCars());
        printCars((Iterator) special.theCars());
        printCars((Iterator) concept.theCars());
    }
    ...
    public static void printCars(Iterator it) {
        while (it.hasNext()) {
            CarsProduction c = (CarsProduction) it.next(allSedanCars);
